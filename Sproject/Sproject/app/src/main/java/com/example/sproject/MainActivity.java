...
public class MainActivity extends AppCompatActivity {
    ...
    FloatingActionButton fabBookTour;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Sample data
        List<Item> popularItems = Arrays.asList(
        ...
        // Set up adapters
        popularAdapter = new MyAdapter(popularItems);
        categoryAdapter = new MyAdapter(categoryItems);
